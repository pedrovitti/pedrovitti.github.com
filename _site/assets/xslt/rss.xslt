...
<xsl:template match="/rss">
	...
	<meta property="og:site_name" content="pedrovitti">
	
	<meta property="article:author" content="https://www.facebook.com/pedrovitti">


	
	<!-- Twitter -->
	<meta name="twitter:card" content="summary">
	<meta name="twitter:site" content="pedrovitti">
	<meta name="twitter:creator" content="pedrovitti">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="" class="icon-tree"> pedrovitti</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="" title="pedrovitti – A Flexible Theme for Jekyll">
				<img src="/assets/img/logo.png" alt="pedrovitti – A Flexible Theme for Jekyll">
			</a>
